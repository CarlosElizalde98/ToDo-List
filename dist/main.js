...
const switchTabs = (()=> {
    ...
    const switchTab = (item) => {
        const inbox = document.querySelector('.inbox-container');
            ...
            _DOMconstructor_js__WEBPACK_IMPORTED_MODULE_0__.createPage.addInboxItem(inbox, header);
            addTaskEventListener();
            }
    }
