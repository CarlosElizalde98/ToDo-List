        ...
        if (localStorage.length > 0) {
            for (let i = 0; i < localStorage.length; i++){
                if (!(localStorage.key(i).includes("Project"))) {
                    ...
                    let project = _toDoConstructor_js__WEBPACK_IMPORTED_MODULE_1__.toDo.getTaskData(localStorage.key(i));
                    addSidebarItem(localStorage.key(i));
                }
            }
            _switchTabs_js__WEBPACK_IMPORTED_MODULE_0__.switchTabs.removeProjectListener();
        }
    }
